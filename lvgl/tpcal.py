...
#disp = ili9341(miso=19, mosi=23, clk=18, cs=26, dc=5, rst=33, power=14, backlight=15, mhz=40, factor=4, hybrid=True, rot=MADCTL_MY)
disp = ili9341(miso=19, mosi=23, clk=18, cs=26, dc=5, rst=33, power=-1, backlight=-1, mhz=40, factor=4, hybrid=True, width=320, height=240, rot=LANDSCAPE)
...
touch = xpt2046(cs=27, cal_x0=0, cal_x1 = HRES, cal_y0=0, cal_y1 = VRES, transpose=False)
